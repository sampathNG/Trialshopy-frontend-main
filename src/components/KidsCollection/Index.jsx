...
import BoyCollection from './boys/Index';
import GirlCollection from './girls/Index';
	...
	return (
		<div className="grid grid-cols-1 lg:grid-cols-5 w-full gap-4 overflow-auto">
			<div
				...
				<div className="flex lg:hidden flex-row items-center justify-end w-full px-4">
					<div
			...
			<div
				...
				<div className="flex flex-col items-start gap-2 w-full">
					<div className="font-semibold text-3xl ">Kid&apos;s Collection</div>

					<div className="flex items-center justify-start gap-4">
						<div
							className={`text-lg uppercase ${
								activeTab === 'girls'
									? 'font-semibold  underline underline-offset-8 decoration-[#EB8105]'
									: ''
							}`}
							onClick={(e) => handleActiveTab('girls')}>
							Girls Collection
						</div>
						<div
							className={`text-lg uppercase ${
							...
							onClick={() => handleActiveTab('boys')}>
							Boys Collection
						</div>
					</div>
					{activeTab === 'boys' && <BoyCollection />}
					{activeTab === 'girls' && <GirlCollection />}
				</div>
