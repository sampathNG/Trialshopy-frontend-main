...
const NearByBeauty = () => {
	...
	useEffect(() => {
		...
		axios
			.post(api, {
				filters: {
					parent: '64b9005288cb61a80b5cf50b',
				},
			})
	...
	useEffect(() => {
		...
		if (userLocation) {
			const api = `${serverURL}/api/v1/getNearBeauty?latitude=${
	...
	return (
		<div className="">
			...
			<CircularCardGrid title={'Beauty & Cosmetics'} cards={categories} />
