...
const NearByElectronics = () => {
	...
	useEffect(() => {
		...
		axios
			.post(api, {
				filters: {
					parent: '64b9001088cb61a80b5cf501',
				},
			})
	...
	useEffect(() => {
		...
		if (userLocation) {
			const api = `${serverURL}/api/v1/getNearElectronics?latitude=${
	...
	return (
		<div className="">
			...
			<CircularCardGrid title={'Electronics'} cards={categories} />
...
export default NearByElectronics;
