...
const NearByFurniture = () => {
	...
	useEffect(() => {
		...
		axios
			.post(api, {
				filters: {
					parent: '64b9003888cb61a80b5cf507',
				},
			})
	...
	useEffect(() => {
		...
		if (userLocation) {
			const api = `${serverURL}/api/v1/getNearFurniture?latitude=${
	...
	return (
		<div className="">
			...
			<CircularCardGrid title={'Furniture'} cards={categories} />
...
export default NearByFurniture;
