...
const NearByJewellery = () => {
	...
	useEffect(() => {
		...
		if (userLocation) {
			const api = `${serverURL}/api/v1/getNearJewellery?latitude=${
	...
	return (
		<div className="">
			...
			<CircularCardGrid title={'Jewellery'} cards={categories} />
...
export default NearByJewellery;
